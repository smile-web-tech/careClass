...
const GLYPHS = {
  ...
  */
  ...
  refresh: {
    box: 18,
    sw: 1.7,
    d: ['M15.2 9a6.2 6.2 0 1 1-1.9-4.5', 'M15.4 2.7v3.6h-3.6'],
  },
  cloudUp: {
    box: 18,
    sw: 1.6,
    d: [
      'M5.2 13.5a3.1 3.1 0 0 1-.3-6.2 4.2 4.2 0 0 1 8.1-.6 2.9 2.9 0 0 1 .3 5.7',
      'M9 15.4V8.6',
      'm6.9 10.6 2.1-2.1 2.1 2.1',
    ],
  },
  paperclip: {
    box: 18,
    sw: 1.6,
    d: [
      'M11.8 7.2 7.6 11.4a1.6 1.6 0 0 0 2.3 2.3l4.5-4.5a2.9 2.9 0 0 0-4.1-4.1L5.4 9.9a4.1 4.1 0 0 0 5.8 5.8l1.1-1.1',
    ],
  },
  image: {
    box: 18,
    sw: 1.6,
    rects: [[2.5, 3.5, 13, 11, 2.5]],
    circles: [[6.4, 7.1, 1.2]],
    d: ['m3.4 12.6 3.8-3.6 3 2.8 2.4-2.2 2.7 3'],
  },
  phone: {
    box: 18,
    sw: 1.7,
