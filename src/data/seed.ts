...
const drafts: Draft[] = [
  ...
  { id: 's-aziz', name: 'Aziz Karimov', phone: '+998 94 123 45 60', groupIds: ['g-algebra'], avgScore: 6.8 },
  { id: 's-zilola', name: 'Zilola Rakhimova', phone: '+998 95 234 56 71', groupIds: ['g-algebra'], avgScore: 8.4 },
  { id: 's-shahzod', name: 'Shahzod Mirzaev', phone: '+998 97 345 67 82', groupIds: ['g-beginners'], avgScore: 6.5 },
  { id: 's-madina', name: 'Madina Tursunova', phone: '+998 88 456 78 93', groupIds: ['g-beginners'], avgScore: 7.0 },
  { id: 's-javohir', name: 'Javohir Ergashev', phone: '+998 90 567 89 04', groupIds: ['g-beginners'], avgScore: 5.9 },
  { id: 's-nilufar', name: 'Nilufar Qodirova', phone: '+998 91 678 90 15', groupIds: ['g-beginners'], avgScore: 7.6 },
  { id: 's-sardor', name: 'Sardor Alimov', phone: '+998 93 789 01 26', groupIds: ['g-beginners'], avgScore: 6.1 },
  { id: 's-dilshod', name: 'Dilshod Yuldashev', phone: '+998 94 890 12 37', groupIds: ['g-beginners'], avgScore: 6.7 },
  { id: 's-feruza', name: 'Feruza Nazirova', phone: '+998 95 901 23 48', groupIds: ['g-beginners'], avgScore: 7.2 },
  { id: 's-ulugbek', name: 'Ulugbek Sobirov', phone: '+998 97 012 34 59', groupIds: ['g-beginners'], avgScore: 5.8 },
  { id: 's-aziza', name: 'Aziza Tashkentova', phone: '+998 88 123 45 61', groupIds: ['g-beginners'], avgScore: 8.1 },
  { id: 's-rustam', name: 'Rustam Ibragimov', phone: '+998 90 234 56 72', groupIds: ['g-physics'], avgScore: 8.8 },
  { id: 's-laziza', name: 'Laziza Sharipova', phone: '+998 91 345 67 83', groupIds: ['g-physics'], avgScore: 7.7 },
];
