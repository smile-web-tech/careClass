...
const lightAccents: AccentSet = {
  blue: { dot: '#2457E8', tint: '#EAF0FE', ink: '#2457E8', inkDeep: '#1B44BC', sub: '#7C93C4', dotDark: '#4E85FF', inkDark: '#9CBBFF', headerFrom: '#1B44BC', headerTo: '#0C1729' },
  teal: { dot: '#0E8C8C', tint: '#E3F4F4', ink: '#0E8C8C', inkDeep: '#0B6E6E', sub: '#6BA5A5', dotDark: '#3FC9C9', inkDark: '#8FE0E0', headerFrom: '#0A6B6B', headerTo: '#0C1729' },
  violet: { dot: '#5B45C9', tint: '#EDEAFB', ink: '#5B45C9', inkDeep: '#4A37A6', sub: '#8E7FD6', dotDark: '#8B78F0', inkDark: '#BFB4F7', headerFrom: '#3F2E93', headerTo: '#0C1729' },
  amber: { dot: '#C39B4E', tint: '#FBEFDC', ink: '#A8730B', inkDeep: '#7A4E10', sub: '#C39B4E', dotDark: '#F0B454', inkDark: '#F5D49A', headerFrom: '#7A5410', headerTo: '#0C1729' },
  rose: { dot: '#E5484D', tint: '#FDEBEC', ink: '#C13136', inkDeep: '#9B2429', sub: '#D28A8D', dotDark: '#FF7A7F', inkDark: '#FFB3B6', headerFrom: '#93242A', headerTo: '#0C1729' },
  emerald: { dot: '#0E9F6E', tint: '#E6F6EF', ink: '#0B7C55', inkDeep: '#085F42', sub: '#6FAE93', dotDark: '#3FD292', inkDark: '#8FE8C4', headerFrom: '#0A6444', headerTo: '#0C1729' },
  indigo: { dot: '#4634C4', tint: '#EAE8FA', ink: '#3B2BA6', inkDeep: '#2C1F7D', sub: '#8579D2', dotDark: '#8C7BFF', inkDark: '#BDB4FF', headerFrom: '#2E2183', headerTo: '#0C1729' },
  orange: { dot: '#E2662A', tint: '#FDEEE4', ink: '#C1541F', inkDeep: '#94400F', sub: '#D2967A', dotDark: '#FF9152', inkDark: '#FFC4A0', headerFrom: '#97430F', headerTo: '#0C1729' },
  cyan: { dot: '#0891B2', tint: '#E2F4F9', ink: '#0E7490', inkDeep: '#0A5A70', sub: '#6BAAC0', dotDark: '#38C7E8', inkDark: '#94E0F3', headerFrom: '#0A5A70', headerTo: '#0C1729' },
  pink: { dot: '#D63384', tint: '#FCE9F2', ink: '#B02A6C', inkDeep: '#8A2054', sub: '#D08AAF', dotDark: '#F472B6', inkDark: '#FAB4D8', headerFrom: '#8A2054', headerTo: '#0C1729' },
  lime: { dot: '#6A9E1F', tint: '#F0F7E2', ink: '#55801A', inkDeep: '#3F6112', sub: '#A0BC79', dotDark: '#A3D34A', inkDark: '#CDE894', headerFrom: '#41630F', headerTo: '#0C1729' },
  slate: { dot: '#5A6B85', tint: '#EDF1F7', ink: '#47566E', inkDeep: '#333F54', sub: '#93A2B8', dotDark: '#8FA0B8', inkDark: '#BECBDC', headerFrom: '#37445C', headerTo: '#0C1729' },
};

const darkAccents: AccentSet = {
  blue: { dot: '#2F63F0', tint: '#1B2742', ink: '#7FA2FF', inkDeep: '#7FA2FF', sub: '#8FA9DE', dotDark: '#6E9BFF', inkDark: '#A9C4FF', headerFrom: '#224CC9', headerTo: '#0B1220' },
  teal: { dot: '#4CD0D0', tint: '#0F2C2E', ink: '#4CD0D0', inkDeep: '#4CD0D0', sub: '#63B4B4', dotDark: '#5FD9D9', inkDark: '#8FE0E0', headerFrom: '#0E6E70', headerTo: '#0B1220' },
  violet: { dot: '#A493FF', tint: '#221E3A', ink: '#A493FF', inkDeep: '#A493FF', sub: '#9F91EB', dotDark: '#B4A6FF', inkDark: '#C9BEFF', headerFrom: '#4633A8', headerTo: '#0B1220' },
  amber: { dot: '#E5AB3F', tint: '#2C2415', ink: '#E5AB3F', inkDeep: '#E8963A', sub: '#C9A462', dotDark: '#F0B454', inkDark: '#F5D49A', headerFrom: '#8A6114', headerTo: '#0B1220' },
  rose: { dot: '#FF7A7F', tint: '#2C1A1C', ink: '#F1666B', inkDeep: '#F1666B', sub: '#C08F94', dotDark: '#FF9296', inkDark: '#FFB3B6', headerFrom: '#8E2F33', headerTo: '#0B1220' },
  emerald: { dot: '#3FD292', tint: '#12291F', ink: '#38C98A', inkDeep: '#38C98A', sub: '#6FAB94', dotDark: '#5CDDA5', inkDark: '#8FE8C4', headerFrom: '#12634A', headerTo: '#0B1220' },
  indigo: { dot: '#8C7BFF', tint: '#1E1B38', ink: '#A79AFF', inkDeep: '#A79AFF', sub: '#9186D6', dotDark: '#A294FF', inkDark: '#BDB4FF', headerFrom: '#362A8E', headerTo: '#0B1220' },
  orange: { dot: '#FF9152', tint: '#2E1E12', ink: '#FFA470', inkDeep: '#FFA470', sub: '#C4906B', dotDark: '#FFA470', inkDark: '#FFC4A0', headerFrom: '#8A4415', headerTo: '#0B1220' },
  cyan: { dot: '#38C7E8', tint: '#0D2830', ink: '#4FD3F0', inkDeep: '#4FD3F0', sub: '#6FA9BA', dotDark: '#63D8F2', inkDark: '#94E0F3', headerFrom: '#0E5C74', headerTo: '#0B1220' },
  pink: { dot: '#F472B6', tint: '#2E1626', ink: '#F58BC4', inkDeep: '#F58BC4', sub: '#C289A8', dotDark: '#F78FC6', inkDark: '#FAB4D8', headerFrom: '#8C2A61', headerTo: '#0B1220' },
  lime: { dot: '#A3D34A', tint: '#1F2913', ink: '#B0DC5F', inkDeep: '#B0DC5F', sub: '#96AC72', dotDark: '#B8E070', inkDark: '#CDE894', headerFrom: '#4E6E18', headerTo: '#0B1220' },
  slate: { dot: '#8FA0B8', tint: '#212934', ink: '#A9B8CC', inkDeep: '#A9B8CC', sub: '#7A899F', dotDark: '#A2B1C6', inkDark: '#BECBDC', headerFrom: '#414F66', headerTo: '#0B1220' },
};
